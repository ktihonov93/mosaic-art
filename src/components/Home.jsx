...
function Home() {
  ...
  const getArtwork = async () => {
    ...
    let resArtwork = await axios.get(
    ...
    let resDescription = await axios.get(
      `https://api.artic.edu/api/v1/artworks/${newResArtwork.id}/manifest.json`
    );
  ...
  return (
    ...
    `}
          ...
          <div className="main-text">
            <div>
              {" "}
              {artwork != null && artwork !== undefined && description}{" "}
            </div>
